...
const lines = [
  { prefix: 'INTELL', text: 'Patrón operativo aprendido en tu planta', delay: 0 },
  { prefix: 'INTELL', text: 'Anomalía multivariable detectada — en revisión', delay: 0.4 },
  { prefix: 'INTELL', text: 'Ventana de mantenimiento sugerida ✓', highlight: true, delay: 0.8 },
  { prefix: 'OPT', text: 'Parámetros de proceso dentro de rango óptimo', delay: 1.2 },
]
    ...
    <div className="relative mx-auto w-full max-w-xl">
      ...
      >
        <div className="flex items-center gap-2 border-b border-white/5 bg-black/50 px-5 py-3">
          ...
          <span className="font-mono text-xs text-neutral-500">synect-intell — motor predictivo</span>
        </div>

        <div className="space-y-3 p-6 font-mono text-sm">
          <p className="text-neutral-500">
            <span className="text-synect-orange">$</span> intell analyze --plant-id
          </p>
        ...
        <div className="border-t border-white/5 bg-synect-orange/[0.04] px-6 py-3 font-mono text-[10px]">
          ...
          <span className="ml-3 text-synect-orange">PREDICTIVO</span>
          <span className="ml-6 text-neutral-600">ESTADO</span>
          <span className="ml-3 text-white">OPTIMIZANDO</span>
        </div>
      </motion.div>
    </div>
  )
